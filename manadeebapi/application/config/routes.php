...
$route['api/getdata/GetRequestProduct'] = 'api/getdata/GetRequestProducts';
$route['api/getdata/getvaliableProduct'] = 'api/getdata/getvaliableProducts';
$route['api/getdata/GetUnpaymentcuslist'] = 'api/getdata/GetUnpaymentcuslists';
